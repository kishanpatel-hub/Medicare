 ...
 */
@WebServlet("/DeleteAppointmentDoctor")
public class DeleteAppointmentDoctor extends HttpServlet {
	  ...
	  public void doGet(HttpServletRequest req, HttpServletResponse resp)
	    ...
	    try {
			...
			throw new IOException(e);
        	 ...
        	 req.getRequestDispatcher("/FindAppointmentforDoctor").forward(req, resp); 	
