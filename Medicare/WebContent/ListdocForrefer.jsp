...
<h1>Search doctor</h1>
    ...
    <form action="FindDoctorforreferal" method="post">
        <p>
			<label for="patientreferd">Patient ID: </label>
			<input type="text" id="patientreferd" name="patientreferd" value="${fn:escapeXml(param.patientID)}">
		</p>
        ...
        <table border="5">
            ...
            <c:forEach items="${doctorList}" var="Doctor" >
                <tr>
                    ...
                    <td><a href="DoctorRefferal.jsp?referto=<c:out value="${Doctor.getDoctor_ID()}"/>">refer</a></td>
                </tr>
            </c:forEach>
       </table>
       </div>
